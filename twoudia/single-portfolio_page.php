...
<?php get_footer(); ?>
<?php 
	$strjQuery = "<script type='text/javascript'>(function($) {".
			"$(document).ready(function() {".
			"function isEmpty( el ){".
      				"return !$.trim(el.html());".
  			"};".
			"setTimeout(function() {".
				"if (isEmpty($('body.single-portfolio_page > div.wrapper > div > div.content.content_top_margin_none > div.content_inner > div > div > div > div.two_columns_66_33.clearfix.portfolio_container > div.column1 > div > div.portfolio_images'))) {".
					"$('body.single-portfolio_page > div.wrapper > div > div.content.content_top_margin_none > div.content_inner > div > div > div > div.two_columns_66_33.clearfix.portfolio_container > div.column1').css('width', '0%');".
					"$('body.single-portfolio_page > div.wrapper > div > div.content.content_top_margin_none > div.content_inner > div > div > div > div.two_columns_66_33.clearfix.portfolio_container > div.column2').css('width', '99%');".
					"$('div.q_message_icon_holder').css('height', 'initial');".
				"}".
			"});".
		"})".
		"})(jQuery);</script>";
