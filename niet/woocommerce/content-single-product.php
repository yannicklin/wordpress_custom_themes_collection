...
<?php if( get_field('course_id') ): ?><p class="courseid"><?php the_field('course_id'); ?></p><?php endif; ?>
...
<?php if( get_field('enrol_url') ): ?><div class="nietbookingbuttonwrapper"><a class="nietbookingbutton" href="<?php the_field('enrol_url'); ?>">Enrol Now</a></div><?php endif; ?>
		<div class="selector">
			<?php
