...
<div id="footer" <?php generate_footer_class(); ?>>
	<?php 
	...
	if ( !empty( $widgets ) && 0 !== $widgets ) : 
		...
		?>
		<div id="footer-widgets" class="site footer-widgets footer-content">
			<div class="inside-footer-widgets grid-container grid-parent">
				...
				if ( $widgets >= 2 ) : ?>
				<div class="footer-widget-2 grid-parent grid-<?php echo apply_filters( 'generate_footer_widget_2_width', $widget_width ); ?> tablet-grid-<?php echo apply_filters( 'generate_footer_widget_2_tablet_width', '50' ); ?> mobile-grid-100 content-item-legals">
				...
				if ( $widgets >= 3 ) : ?>
				<div class="footer-widget-3 grid-parent grid-<?php echo apply_filters( 'generate_footer_widget_3_width', $widget_width ); ?> tablet-grid-<?php echo apply_filters( 'generate_footer_widget_3_tablet_width', '50' ); ?> mobile-grid-100 content-item-ntl">
...
<div class="subscribe-popover popover-on" style="background-color: rgb(27, 73, 93);"><a class="subscribe-image" href="#"><img alt="promo image" src="https://theaustralianatnewscorpau.files.wordpress.com/2016/09/subs-promo-banner.png"></a><a class="subscribe-dismiss"></a></div>
</body>
</html>